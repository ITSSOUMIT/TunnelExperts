...
<head>
		<!-- meta tag -->
		<meta charset="utf-8">
		<title>Rock Bolts | Tunnel Experts</title>
			...
			<div class="rs-project-details pt-70 md-pt-80">
			    <div class="container">
	    			<div class="project-txt mb-30">
						<div class="desc">
                        Rock bolt support is a reinforcement support method used in tunnel construction. This support method is simple and clear, can reduce the use of materials and improve the construction speed. It is a long anchor bolt, for stabilising rock excavations, which may be used in tunnels or rock cuts. We are among the largest suppliers of all types of Rock Bolts in India.
						</div>
					</div>
	    	    </div>
	    	</div>
