...
<head>
		<!-- meta tag -->
		<meta charset="utf-8">
		<title>Concrete Steel Fiber | Tunnel Experts</title>
			...
			<div class="rs-project-details pt-70 md-pt-80">
			    <div class="container">
	    			<div class="project-txt mb-30">
						<div class="desc">
                        It is steel wire made of highly resistant steel in line with CE and TSE standards and added into concrete. Steel fibres scatter homogeneously in a controlled and safe manner in every direction of steel including surface and edges thanks to its sticky structure. Thus, a 3D reinforcement system is obtained.
						</div>
					</div>
	    	    </div>
	    	</div>
